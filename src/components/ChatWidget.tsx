...
export function ChatWidget() {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-24 left-6 z-[95] flex h-[min(32rem,70vh)] w-[min(24rem,calc(100vw-3rem))] flex-col overflow-hidden rounded-[var(--radius-base)] border border-hairline-strong bg-card shadow-[var(--shadow-panel)]">
