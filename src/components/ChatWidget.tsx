  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 left-6 z-[90] flex h-14 w-14 items-center justify-center rounded-full bg-navy-700 text-on-navy shadow-[var(--shadow-panel)] transition-transform duration-200 hover:scale-105 active:scale-95"
      >
        {!open && (
