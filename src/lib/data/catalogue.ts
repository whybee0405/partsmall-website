...
export const CATEGORIES: Category[] = [
  {
    ...
    label: 'Braking',
    icon: 'Disc',
    image: '/images/parts/product-photography/braking-brake-pads-set.webp',
  ...
  },
  {
    ...
    blurb: 'Control arms, stabilizer links, tie rod ends and steering components for a controlled ride.',
    summary:
      'Suspension and steering parts locate the wheels and transmit driver input: control arms and ball joints that guide wheel movement, stabilizer links that manage body roll, and steering components that connect the wheel to the road.',
    intro: [
      ...
      'These parts work as a system. A worn ball joint accelerates wear on the bush next to it, and a worn tie rod end affects the rack end behind it. Replacing one component without checking its neighbours usually means going back in.',
    ...
    faqs: [
      {
        q: 'How do I know if a control arm needs replacing?',
        a: 'A clunk over bumps, vague steering, uneven tyre wear, or visible movement in its bushes or ball joint all point to a worn control arm. Alignment should be checked after replacement.',
      },
      {
...
const RAW_PART_TYPES = [
  ...
  pt(
    ...
    'Gaskets',
    'engine',
    'Engine gaskets seal the mating surfaces between engine components, retaining oil, coolant, air and combustion pressure where each system needs to stay contained.',
    'A gasket fills the microscopic gaps between two bolted surfaces. The material and thickness must suit the temperature, pressure and fluid at that joint, which is why engine-code fitment matters.',
    [
      'Oil or coolant leaking from an engine joint',
      'A ticking exhaust leak from a manifold flange',
      'Rough running caused by an intake air leak',
      'A gasket visibly crushed, split or hardened after removal',
    ],
    'Replace whenever the sealed component is removed, or when a leak develops. Most engine gaskets are single-use and should not be refitted.',
    [
      'Engine code and the exact component being sealed',
      'Whether bolts or seals are single-use and needed with the gasket',
      'The mating surfaces must be clean, flat and free of old gasket material',
      'Correct gasket thickness or grade where more than one is specified',
    ],
    [
      {
        q: 'Can an old engine gasket be reused?',
        a: 'Usually not. Most gaskets compress when tightened and do not seal reliably a second time. Fit a new gasket whenever the joint is opened.',
      },
      {
        q: 'Why does the engine code matter for a gasket?',
        a: 'Engines with the same capacity can use different port shapes, bolt patterns and gasket thicknesses. The engine code confirms the exact sealing set required.',
      },
    ],
  ),
  pt(
  ...
  pt(
    ...
    'Control Arms',
    'suspension-steering',
    'Control arms locate the wheel hub while allowing the suspension to move through its travel, using bushes at the chassis and a ball joint at the hub.',
    'The arm holds wheel geometry under braking and cornering. Its bushes allow a controlled pivot while the ball joint lets the hub steer and move vertically.',
    [
      'A clunk over bumps or when braking',
      'Steering that wanders or pulls',
      'Uneven tyre wear',
      'Visible damage to the arm, bushes or ball joint boot',
    ],
    'Not a scheduled item. Replace when the bushes or ball joint have play, the arm is bent, or corrosion compromises its strength.',
    [
      'Front or rear, and left or right side',
      'Whether bushes and ball joint are included',
      'The vehicle engine and drivetrain, where the arm differs by specification',
      'Wheel alignment should be booked after replacement',
    ],
    [
      {
        q: 'Do control arms need to be replaced in pairs?',
        a: 'Not always, but inspect the matching side. The bushes and ball joints have experienced the same mileage, so replacing both can avoid a second alignment and repair soon after.',
      },
      {
        q: 'Is wheel alignment needed after replacing a control arm?',
        a: 'Yes. A control arm locates the wheel, so alignment should be checked and adjusted once the new arm is fitted.',
      },
    ],
  ),
  pt(
    ...
    'Stabilizer Links',
    'suspension-steering',
    'Stabilizer links connect the anti-roll bar to the suspension, helping the vehicle resist body roll while cornering.',
    'A link transfers movement between the suspension and anti-roll bar. Its small ball joints or bushes work constantly over uneven roads and eventually develop play.',
    [
      'A light rattle or knock over small bumps',
      'A clunk when turning into a driveway',
      'Visible play or a split ball-joint boot',
    ],
    'Not a scheduled item. Replace when play, noise or damaged boots are found during inspection.',
    [
      'Front or rear axle, and left or right where applicable',
      'Link length and mounting style',
      'Whether the vehicle has standard or heavy-duty suspension',
    ],
    [
      {
        q: 'Can worn stabilizer links cause a knocking noise?',
        a: 'Yes. Their ball joints commonly develop play, producing a quick rattle or knock over low-speed bumps.',
      },
    ],
  ),
  pt(
    ...
    'Tie Rod Ends',
    'suspension-steering',
    'Tie rod ends connect the steering rack to the wheel hub, transferring steering movement while allowing the suspension to travel.',
    'The threaded end sets the toe alignment, while the ball joint allows the hub to steer and move independently through suspension travel.',
    [
      'Loose or wandering steering',
      'A knock when turning or driving over bumps',
      'Uneven front tyre wear',
      'Play when the wheel is rocked with the vehicle raised',
    ],
    'Not a scheduled item. Replace when play develops, the boot splits, or the joint is seized during alignment.',
    [
      'Left or right side and thread direction',
      'Thread diameter and pitch at the rack end',
      'Whether the lock nut is included',
      'Wheel alignment is required after fitting',
    ],
    [
      {
        q: 'Is an alignment needed after replacing a tie rod end?',
        a: 'Yes. The tie rod end directly sets front-wheel toe, so the alignment must be checked after it is replaced.',
      },
    ],
  ),
  pt(
    ...
    'Rack Ends',
    'suspension-steering',
    'Rack ends, also called inner tie rods, connect the steering rack to the outer tie rod ends and transfer movement from the rack to the wheels.',
    'The inner ball joint screws to the rack and sits beneath the steering-rack boot. It pivots as the suspension moves while transmitting the rack’s push-and-pull motion.',
    [
      'Play or a clunk felt through the steering',
      'Wandering steering at speed',
      'Uneven tyre wear',
      'Movement at the inner joint beneath the rack boot',
    ],
    'Not a scheduled item. Replace when the inner joint has play or the rack boot has allowed water and grit into the joint.',
    [
      'Left or right side and rack type',
      'Inner thread size and length',
      'Whether a new rack boot and clamps are needed',
      'Wheel alignment is required after fitting',
    ],
    [
      {
        q: 'What is the difference between a rack end and a tie rod end?',
        a: 'The rack end is the inner joint attached to the steering rack; the tie rod end is the outer joint attached to the wheel hub. Together they form the steering linkage.',
      },
    ],
  ),
  pt(
...
export const BRANDS: Brand[] = [
  ...
  { slug: 'a-gist', label: 'A-GIST', tier: 'private', note: 'Premium filter parts for Korean vehicle applications.', logo: '/images/brands/a-gist-official.png' },
  { slug: 'mando', label: 'MANDO', tier: 'private', note: 'Korean OEM parts for trusted replacement fitment.', logo: '/images/brands/mando-official.png' },
]
